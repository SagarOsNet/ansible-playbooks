...
* also needed Microsoft's Visual C++ redistributable installed manually. 
Cause  without it, Apache's
program (httpd.exe) fails to even strt, with no error msg shown.
